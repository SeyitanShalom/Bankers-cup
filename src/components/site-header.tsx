          ...
          {navItems.map((item) => {
            ...
            return (
              <Link
                key={item.href}
                href={item.href}
                className="inline-flex min-h-10 shrink-0 items-center gap-2 rounded-md px-3 text-sm font-bold text-zinc-600 transition hover:bg-emerald-50 hover:text-emerald-800"
              >
