    ...
    <main>
      <section className="relative isolate overflow-hidden bg-zinc-950 text-white">
        <Image
          ...
          fill
          priority
          className="hero-drift object-cover object-[66%_center]"
          sizes="100vw"
        />
        <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(9,9,11,0.90)_0%,rgba(9,9,11,0.68)_38%,rgba(9,9,11,0.46)_72%,rgba(9,9,11,0.12)_100%)]" />
        ...
        <div className="relative mx-auto flex min-h-[72svh] max-w-7xl flex-col justify-end px-4 pb-14 pt-16 sm:px-6 sm:pb-16 lg:px-8">
          <div className="animate-rise-in max-w-4xl">
            ...
            <div className="animate-rise-in motion-delay-3 mt-7 flex flex-wrap gap-3">
              <Link
                href="/fixtures"
                className="group inline-flex min-h-11 items-center gap-2 rounded-md bg-amber-300 px-4 text-sm font-black text-zinc-950 transition hover:-translate-y-0.5 hover:bg-amber-200"
              >
                Fixtures
              ...
              <Link
                href="/standings"
                className="group inline-flex min-h-11 items-center gap-2 rounded-md border border-white/25 bg-white/10 px-4 text-sm font-black text-white backdrop-blur transition hover:-translate-y-0.5 hover:border-emerald-300/70 hover:bg-emerald-500/20"
              >
                Full table
                <ArrowRight className="h-4 w-4 transition group-hover:translate-x-0.5" aria-hidden="true" />
              </Link>
      ...
      <section className="mx-auto grid max-w-7xl gap-6 px-4 py-8 sm:px-6 lg:grid-cols-[1.45fr_0.85fr] lg:px-8">
        <div className="space-y-6">
          <div className="flex flex-wrap items-end justify-between gap-3">
            ...
            <Link
              href="/standings"
              className="group inline-flex min-h-10 items-center gap-2 rounded-md bg-zinc-950 px-4 text-sm font-bold text-white transition hover:-translate-y-0.5 hover:bg-emerald-800"
            >
              Full Table
              <ArrowRight className="h-4 w-4 transition group-hover:translate-x-0.5" aria-hidden="true" />
            </Link>
